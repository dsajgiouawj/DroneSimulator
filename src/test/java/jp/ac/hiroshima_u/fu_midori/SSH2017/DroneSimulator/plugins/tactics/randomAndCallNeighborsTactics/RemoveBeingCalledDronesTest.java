 ...
 */
public class RemoveBeingCalledDronesTest {
    private RemoveBeingCalledDrones sut;
    ...
    public void setUp() throws Exception {
        for (int i = 0; i < NUM_DRONE; i++) {
            drones.add(new DroneController(mock(Drone.class), NUM_DRONE, i, 10, 10, 10, mock(SelectCalleeMediator.class), true, 0.5));
        }
        sut = new RemoveBeingCalledDrones(drones);
    }
