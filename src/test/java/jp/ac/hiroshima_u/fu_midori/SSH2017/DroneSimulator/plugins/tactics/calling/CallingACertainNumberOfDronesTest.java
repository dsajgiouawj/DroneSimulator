 ...
 */
public class CallingACertainNumberOfDronesTest {
    private CallingACertainNumberOfDrones sut;
    ...
    private Caller caller = mock(Caller.class);
    ...
    public void setUp() throws Exception {
        ...
        sut = new CallingACertainNumberOfDrones(drones, caller, CERTAIN_NUMBER, fm);
    }
