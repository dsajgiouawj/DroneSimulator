...
public class DroneControllerTest {
    ...
    public static class 最初に螺旋探索を行う場合 {
        ...
        public void setUp() throws Exception {
            sut = new DroneController(droneSpy, NUM_DRONE, ID, VIEW_RANGE_RADIUS, TURN_INTERVAL, LIMIT_OF_TURNING_ANGLE, selectCalleeMediator, true, SEARCH_RATIO);
            droneSpy.nextTurn();
        }
        ...
        public void executeTurnを実行すると螺旋探索() throws Exception {
            ...
            jp.ac.hiroshima_u.fu_midori.SSH2017.DroneSimulator.plugins.tactics.spiralTactics.DroneController spiralTacticsDrone = new jp.ac.hiroshima_u.fu_midori.SSH2017.DroneSimulator.plugins.tactics.spiralTactics.DroneController(droneForSpiral, NUM_DRONE, ID, VIEW_RANGE_RADIUS, SEARCH_RATIO);
    ...
    public static class 最初に螺旋探索を行わない場合 {
        ...
        @Before
        public void setUp() throws Exception {
            sut = new DroneController(droneSpy, NUM_DRONE, ID, VIEW_RANGE_RADIUS, TURN_INTERVAL, LIMIT_OF_TURNING_ANGLE, selectCalleeMediator, false, 0.5);
            droneSpy.nextTurn();
        }
