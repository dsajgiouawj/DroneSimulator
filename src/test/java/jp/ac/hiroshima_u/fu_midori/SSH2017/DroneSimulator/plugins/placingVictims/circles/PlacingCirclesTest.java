...
/**
 * PlacingCirclesの簡易的なテスト
 *
 * @author 遠藤拓斗 on 2017/06/11.
 */
public class PlacingCirclesTest {
    private PlacingCircles sut;
    ...
    public void setUp() throws Exception {
        sut = new PlacingCircles(centerOfRange, radiusOfRange, radiusOfCircles, numOfCircles);
    }
    ...
    public void radiusOfCirclesがradiusOfRange以上だと例外を送出() throws Exception {
        sut = new PlacingCircles(centerOfRange, 1000, 1000, numOfCircles);
    }

    @Test
    public void radiusOfCirclesがradiusOfRange未満だと例外を送出しない() throws Exception {
        sut = new PlacingCircles(centerOfRange, 1000, 999.9, numOfCircles);
    }
