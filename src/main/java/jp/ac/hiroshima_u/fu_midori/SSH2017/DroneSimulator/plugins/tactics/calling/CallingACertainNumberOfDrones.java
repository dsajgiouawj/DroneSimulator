 ...
 */
public class CallingACertainNumberOfDrones implements SelectCalleeMediator {
    ...
    public CallingACertainNumberOfDrones(List<Drone> drones, Caller caller, int certainNumber, FiltersManagement filters) {
