 ...
 */
public class CallingDronesWhichHaveNotCalledRecently implements CallingFilter {
    private int time = 0;
     ...
     * @param drones ドローン
     */
    public CallingDronesWhichHaveNotCalledRecently(int thresholdTime, List<Drone> drones) {
