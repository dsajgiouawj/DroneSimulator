 ...
 */
public class CallIfNotNearFromThePastCallingPoints implements CallingFilter {
     ...
     */
    public CallIfNotNearFromThePastCallingPoints(List<Drone> drones, double thresholdDistance) {
        this.drones = drones;
