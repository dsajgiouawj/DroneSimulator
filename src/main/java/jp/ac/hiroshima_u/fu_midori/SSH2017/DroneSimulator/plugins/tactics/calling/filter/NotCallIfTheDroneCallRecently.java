 ...
 */
public class NotCallIfTheDroneCallRecently implements CallingFilter {
    private int time = 0;
     ...
     * @param drones ドローン
     */
    public NotCallIfTheDroneCallRecently(int thresholdTime, List<Drone> drones) {
    ...
    public String toString(){
        return "発見したドローンが最後に呼び出しを行ってから"+thresholdTime+"秒以上経過していなければ呼び出しを行わない";
    }
}
