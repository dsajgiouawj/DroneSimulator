 ...
 */
public class CallingDronesWhichHaveNotFindRecently implements CallingFilter {
    private int time = 0;
     ...
     * @param drones        ドローン
     */
    public CallingDronesWhichHaveNotFindRecently(int thresholdTime, List<Drone> drones) {
